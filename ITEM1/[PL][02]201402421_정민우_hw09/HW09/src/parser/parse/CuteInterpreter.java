...
public class CuteInterpreter {
	...
	private Node runFunction(FunctionNode operator, ListNode operand) {
		...
		case ATOM_Q:
//			Node test = runExpr(operand.car());
//			if(test instanceof ListNode) { //리스트노드인경우
//				if( runQuote(  ((ListNode)((ListNode)test).car())  )==null) return BooleanNode.TRUE_NODE;
//				else return BooleanNode.FALSE_NODE;
//			} else if (test instanceof QuoteNode) { //쿼트노드인경우
//				test = ((QuoteNode) test).nodeInside();//쿼트벗기고
//				if( ((ListNode)test).car()==null) return BooleanNode.TRUE_NODE;
//				else return BooleanNode.FALSE_NODE;
//			}
